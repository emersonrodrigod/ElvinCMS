...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        {{Lang::choice('cms_nav.Testimonials', 2)}}
        @include('cms.includes.notes.headerIndex')
      </h1>
      {!! Breadcrumbs::render('admin-testimonials') !!}    
    </section>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <table id="data-table" class="table table-bordered table-striped">
                <thead>
                  <tr>
                    <th>@lang('cms_testimonials.Person')</th>
                    <th>@lang('cms_testimonials.Text')</th>
                    <th>@lang('cms_testimonials.Is Approved')</th>
                    <th>@lang('_.Action')</th>
                  </tr>
                </thead>
                <tbody>
